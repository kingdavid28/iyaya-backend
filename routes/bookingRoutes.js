...
const validateBooking = [
  ...
  body("children")
    .isArray({ min: 1 })
    .withMessage("At least one child is required")
    .custom((children) => {
  ...
  body("contact")
    ...
    .isLength({ max: 100 })
    .withMessage("Contact information must be less than 100 characters"),
  body("hourlyRate")
    .isNumeric()
...
router.post(
  ...
  sanitizeInput,
  validateBooking,
  bookingControllerNew.createBooking,
);
...
router.post(
  ...
  bookingControllerNew.uploadPaymentProof,
);
